...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState == null || mAdapter.items.isEmpty()) {
            ...
            mAdapter.items = savedInstanceState.getSerializable(EXTRA_PEOPLE_LIST) as ArrayList<StarWarsPeopleData> // Obtem a lista de itens
        ...
        disposable = starWarsApiService.starWarsPeople(page)
            ...
            .subscribe(
                fun(result: StarWarsPeople) {
                    ...
                    starWarsOnScrollListener.endReached = result.next == null
                    main_progressBar.visibility = View.INVISIBLE
                    //TODO mPeopleViewModel!!.insert(result.results)
                    /*if(result.next != null){
                        beginSearch(++mPage)
                    }*/
                },
